...
*  @add-classpath dir-or-jarfile@: Adds classpath to environment. Directories should have a trailing / to distinguish them from jar files. 
*  @remove-classpath dir-or-jarfile@: Removes classpath from environment. Remember to include trailing / for directories.
