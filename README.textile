...
** Note: 1) Requires java 1.6 and 2) if your browser added a .zip extension to the jar during download, just run @java -jar cljr-installer.jar.zip@.
...
* *JVM_OPTS*: The default value is "-Xmx1G", other examples @export JVM_OPTS="-Xmx2G -server"@
