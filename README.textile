...
# Run @java -jar cljr-installer.jar@ Note: 1) Requires java 1.6 and 2) if your browser added a .zip extension to the jar during download, just run @java -jar cljr.jar.zip@.
...
@java -Duser.home=C:\ -jar cljr-installer-1.0.0-SNAPSHOT-standalone.jar@
